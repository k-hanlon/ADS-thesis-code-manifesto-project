...
raw_datasets = load_dataset("kghanlon/right_as_train_context", token = use_auth_token)
...
inference_set = raw_datasets["inference_left"]
...
df["preds"] = predict_model("/mimer/NOBACKUP/groups/naiss2024-22-264/kghanlon/right_as_train_context_roberta-large_20e/checkpoint-60255", inference_set, 3)

# save the dataframe:
df.to_csv("right_inference_left_predictions.csv", index=False)