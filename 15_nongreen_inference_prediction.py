...
raw_datasets = load_dataset("kghanlon/non_green_as_train_context", token = use_auth_token)
...
inference_set = raw_datasets["inference"]
...
df["preds"] = predict_model("/mimer/NOBACKUP/groups/naiss2024-22-264/kghanlon/non_green_as_train_contextroberta-large_20e/checkpoint-30956", inference_set, 2)

# save the dataframe:
df.to_csv("nongreen_inference_predictions.csv", index=False)